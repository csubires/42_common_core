...
std::string ContentTypes::getType(const std::string &extension) {
...
const char *ContentTypes::getExtension(const char *type, int skip) {
...
ContentTypes::entry ContentTypes::types[347] = {
		{"*3gpp",                    "audio/3gpp"},
		{"*jpm",                     "video/jpm"},
		{"*mp3",                     "audio/mp3"},
		{"*rtf",                     "text/rtf"},
