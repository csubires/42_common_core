...
/*   Updated: 2024/12/31 19:38:40 by csubires         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	std::cout << GREEN << "ClapTrap Constructor called" << ENDC << std::endl;
}

ClapTrap::ClapTrap() : name(""), hit_points(10), energy_points(10), attack_damage(0)
{
	std::cout << GREEN << "ClapTrap Default constructor called" << ENDC << std::endl;
}

ClapTrap::~ClapTrap()
{
	std::cout << RED << "ClapTrap Destructor called" << ENDC << std::endl;
}
