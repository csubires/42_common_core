...
/*   Updated: 2025/01/01 09:04:02 by csubires         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	std::cout << CYAN << "ClapTrap Constructor called" << ENDC << std::endl;
}

ClapTrap::ClapTrap() : name(""), hit_points(10), energy_points(10), attack_damage(0)
{
	std::cout << CYAN << "ClapTrap Default constructor called" << ENDC << std::endl;
}
